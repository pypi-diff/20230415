# Comparing `tmp/datamol-0.9.6.tar.gz` & `tmp/datamol-0.9.7.tar.gz`
...
### Comparing `datamol-0.9.6/.github/workflows/test.yml` & `datamol-0.9.7/.github/workflows/test.yml`
...
### Comparing `datamol-0.9.6/tests/test_convert.py` & `datamol-0.9.7/tests/test_convert.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_data.py` & `datamol-0.9.7/tests/test_data.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_datamol_import_time.py` & `datamol-0.9.7/tests/test_datamol_import_time.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_descriptors.py` & `datamol-0.9.7/tests/test_descriptors.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_fp.py` & `datamol-0.9.7/tests/test_fp.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_fragment.py` & `datamol-0.9.7/tests/test_fragment.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_graph.py` & `datamol-0.9.7/tests/test_graph.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_io.py` & `datamol-0.9.7/tests/test_io.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_isomers.py` & `datamol-0.9.7/tests/test_isomers.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_log.py` & `datamol-0.9.7/tests/test_log.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_mcs.py` & `datamol-0.9.7/tests/test_mcs.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_mol.py` & `datamol-0.9.7/tests/test_mol.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_molar.py` & `datamol-0.9.7/tests/test_molar.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_notebooks.py` & `datamol-0.9.7/tests/test_notebooks.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_predictors.py` & `datamol-0.9.7/tests/test_predictors.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_reactions.py` & `datamol-0.9.7/tests/test_reactions.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_scaffold.py` & `datamol-0.9.7/tests/test_scaffold.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_similarity.py` & `datamol-0.9.7/tests/test_similarity.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_utils_fs.py` & `datamol-0.9.7/tests/test_utils_fs.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_utils_jobs.py` & `datamol-0.9.7/tests/test_utils_jobs.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_viz.py` & `datamol-0.9.7/tests/test_viz.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_viz_lasso_highlight.py` & `datamol-0.9.7/tests/test_viz_lasso_highlight.py`

 * *Files identical despite different names*

### Comparing `datamol-0.9.6/tests/test_viz_substrcture.py` & `datamol-0.9.7/tests/test_viz_substrcture.py`
