# Comparing `tmp/vollseg-napari-trackmate-2.0.7.tar.gz` & `tmp/vollseg-napari-trackmate-2.1.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "/mnt/c/Users/rando/Downloads/Python_Workspace/vollseg-napari-trackmate/dist/.tmp-a_8asgsq/vollseg-napari-trackmate-2.0.7.tar", last modified: Sat Apr 15 11:27:13 2023, max compression
+gzip compressed data, was "vollseg-napari-trackmate-2.1.0.tar", last modified: Mon Apr  3 07:24:15 2023, max compression
```

## Comparing `vollseg-napari-trackmate-2.0.7.tar` & `vollseg-napari-trackmate-2.1.0.tar`

### file list

```diff
@@ -1,42 +1,42 @@
-drwxrwxrwx   0 debian    (1000) debian    (1000)        0 2023-04-15 11:27:13.737175 vollseg-napari-trackmate-2.0.7/
-drwxrwxrwx   0 debian    (1000) debian    (1000)        0 2023-04-15 11:27:12.597063 vollseg-napari-trackmate-2.0.7/.github/
-drwxrwxrwx   0 debian    (1000) debian    (1000)        0 2023-04-15 11:27:12.797196 vollseg-napari-trackmate-2.0.7/.github/workflows/
--rwxrwxrwx   0 debian    (1000) debian    (1000)     2814 2022-12-31 10:29:11.000000 vollseg-napari-trackmate-2.0.7/.github/workflows/test_and_deploy.yml
--rwxrwxrwx   0 debian    (1000) debian    (1000)      992 2022-12-31 10:29:11.000000 vollseg-napari-trackmate-2.0.7/.gitignore
-drwxrwxrwx   0 debian    (1000) debian    (1000)        0 2023-04-15 11:27:12.853184 vollseg-napari-trackmate-2.0.7/.napari-hub/
--rwxrwxrwx   0 debian    (1000) debian    (1000)      463 2022-12-31 10:29:11.000000 vollseg-napari-trackmate-2.0.7/.napari-hub/DESCRIPTION.md
--rwxrwxrwx   0 debian    (1000) debian    (1000)      542 2022-12-31 10:29:11.000000 vollseg-napari-trackmate-2.0.7/.napari-hub/config.yml
--rwxrwxrwx   0 debian    (1000) debian    (1000)     1211 2022-12-31 12:38:29.000000 vollseg-napari-trackmate-2.0.7/.pre-commit-config.yaml
--rwxrwxrwx   0 debian    (1000) debian    (1000)     1487 2022-12-31 10:29:11.000000 vollseg-napari-trackmate-2.0.7/LICENSE
--rwxrwxrwx   0 debian    (1000) debian    (1000)       96 2022-12-31 10:29:11.000000 vollseg-napari-trackmate-2.0.7/MANIFEST.in
--rwxrwxrwx   0 debian    (1000) debian    (1000)     4320 2023-04-15 11:27:13.738176 vollseg-napari-trackmate-2.0.7/PKG-INFO
--rwxrwxrwx   0 debian    (1000) debian    (1000)     2911 2022-12-31 10:29:11.000000 vollseg-napari-trackmate-2.0.7/README.md
--rwxrwxrwx   0 debian    (1000) debian    (1000)      274 2022-12-31 10:29:11.000000 vollseg-napari-trackmate-2.0.7/pyproject.toml
--rwxrwxrwx   0 debian    (1000) debian    (1000)     1876 2023-04-15 11:27:13.749235 vollseg-napari-trackmate-2.0.7/setup.cfg
-drwxrwxrwx   0 debian    (1000) debian    (1000)        0 2023-04-15 11:27:12.615220 vollseg-napari-trackmate-2.0.7/src/
-drwxrwxrwx   0 debian    (1000) debian    (1000)        0 2023-04-15 11:27:13.165459 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/
--rwxrwxrwx   0 debian    (1000) debian    (1000)      433 2023-01-24 18:36:39.000000 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/__init__.py
--rwxrwxrwx   0 debian    (1000) debian    (1000)    10964 2022-12-29 02:30:28.000000 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/_data_model.py
--rwxrwxrwx   0 debian    (1000) debian    (1000)      644 2022-12-31 10:29:11.000000 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/_sample_data.py
--rwxrwxrwx   0 debian    (1000) debian    (1000)     2118 2023-02-01 20:25:52.000000 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/_temporal_plots.py
-drwxrwxrwx   0 debian    (1000) debian    (1000)        0 2023-04-15 11:27:13.633255 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/_tests/
--rwxrwxrwx   0 debian    (1000) debian    (1000)        0 2022-12-31 10:29:11.000000 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/_tests/__init__.py
--rwxrwxrwx   0 debian    (1000) debian    (1000)      107 2023-01-07 19:22:05.000000 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/_tests/test_reader.py
--rwxrwxrwx   0 debian    (1000) debian    (1000)      115 2022-12-31 10:29:11.000000 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/_tests/test_sample_data.py
--rwxrwxrwx   0 debian    (1000) debian    (1000)      566 2023-01-07 18:24:47.000000 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/_tests/test_widget.py
--rwxrwxrwx   0 debian    (1000) debian    (1000)      133 2022-12-31 10:29:11.000000 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/_tests/test_writer.py
--rwxrwxrwx   0 debian    (1000) debian    (1000)      160 2023-04-15 11:27:11.000000 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/_version.py
--rwxrwxrwx   0 debian    (1000) debian    (1000)    91798 2023-04-15 11:25:21.000000 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/_widget.py
--rwxrwxrwx   0 debian    (1000) debian    (1000)      923 2022-12-31 10:29:11.000000 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/_writer.py
--rwxrwxrwx   0 debian    (1000) debian    (1000)      357 2023-01-07 18:24:48.000000 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/launch.py
--rwxrwxrwx   0 debian    (1000) debian    (1000)     1514 2023-01-03 11:40:24.000000 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/napari.yaml
-drwxrwxrwx   0 debian    (1000) debian    (1000)        0 2023-04-15 11:27:13.683999 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/resources/
--rwxrwxrwx   0 debian    (1000) debian    (1000)     6153 2022-03-22 02:26:26.000000 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/resources/kapoorlogo.png
-drwxrwxrwx   0 debian    (1000) debian    (1000)        0 2023-04-15 11:27:13.401956 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate.egg-info/
--rwxrwxrwx   0 debian    (1000) debian    (1000)     4320 2023-04-15 11:27:11.000000 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate.egg-info/PKG-INFO
--rwxrwxrwx   0 debian    (1000) debian    (1000)     1189 2023-04-15 11:27:12.000000 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate.egg-info/SOURCES.txt
--rwxrwxrwx   0 debian    (1000) debian    (1000)        1 2023-04-15 11:27:11.000000 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate.egg-info/dependency_links.txt
--rwxrwxrwx   0 debian    (1000) debian    (1000)       82 2023-04-15 11:27:11.000000 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate.egg-info/entry_points.txt
--rwxrwxrwx   0 debian    (1000) debian    (1000)       85 2023-04-15 11:27:11.000000 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate.egg-info/requires.txt
--rwxrwxrwx   0 debian    (1000) debian    (1000)       25 2023-04-15 11:27:11.000000 vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate.egg-info/top_level.txt
--rwxrwxrwx   0 debian    (1000) debian    (1000)      619 2022-12-31 10:29:11.000000 vollseg-napari-trackmate-2.0.7/tox.ini
...
### Comparing `vollseg-napari-trackmate-2.0.7/.github/workflows/test_and_deploy.yml` & `vollseg-napari-trackmate-2.1.0/.github/workflows/test_and_deploy.yml`

 * *Files identical despite different names*

### Comparing `vollseg-napari-trackmate-2.0.7/.gitignore` & `vollseg-napari-trackmate-2.1.0/.gitignore`

 * *Files identical despite different names*

### Comparing `vollseg-napari-trackmate-2.0.7/.napari-hub/config.yml` & `vollseg-napari-trackmate-2.1.0/.napari-hub/config.yml`

 * *Files identical despite different names*

### Comparing `vollseg-napari-trackmate-2.0.7/.pre-commit-config.yaml` & `vollseg-napari-trackmate-2.1.0/.pre-commit-config.yaml`

 * *Files identical despite different names*

### Comparing `vollseg-napari-trackmate-2.0.7/LICENSE` & `vollseg-napari-trackmate-2.1.0/LICENSE`

 * *Files identical despite different names*

### Comparing `vollseg-napari-trackmate-2.0.7/PKG-INFO` & `vollseg-napari-trackmate-2.1.0/PKG-INFO`
...
### Comparing `vollseg-napari-trackmate-2.0.7/README.md` & `vollseg-napari-trackmate-2.1.0/README.md`

 * *Files identical despite different names*

### Comparing `vollseg-napari-trackmate-2.0.7/setup.cfg` & `vollseg-napari-trackmate-2.1.0/setup.cfg`

 * *Files identical despite different names*

### Comparing `vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/_data_model.py` & `vollseg-napari-trackmate-2.1.0/src/vollseg_napari_trackmate/_data_model.py`

 * *Files identical despite different names*

### Comparing `vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/_sample_data.py` & `vollseg-napari-trackmate-2.1.0/src/vollseg_napari_trackmate/_sample_data.py`

 * *Files identical despite different names*

### Comparing `vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/_temporal_plots.py` & `vollseg-napari-trackmate-2.1.0/src/vollseg_napari_trackmate/_temporal_plots.py`

 * *Files identical despite different names*

### Comparing `vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/_tests/test_widget.py` & `vollseg-napari-trackmate-2.1.0/src/vollseg_napari_trackmate/_tests/test_widget.py`

 * *Files identical despite different names*

### Comparing `vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/_widget.py` & `vollseg-napari-trackmate-2.1.0/src/vollseg_napari_trackmate/_widget.py`
...
### Comparing `vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/_writer.py` & `vollseg-napari-trackmate-2.1.0/src/vollseg_napari_trackmate/_writer.py`

 * *Files identical despite different names*

### Comparing `vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/napari.yaml` & `vollseg-napari-trackmate-2.1.0/src/vollseg_napari_trackmate/napari.yaml`

 * *Files identical despite different names*

### Comparing `vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate/resources/kapoorlogo.png` & `vollseg-napari-trackmate-2.1.0/src/vollseg_napari_trackmate/resources/kapoorlogo.png`

 * *Files identical despite different names*

### Comparing `vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate.egg-info/PKG-INFO` & `vollseg-napari-trackmate-2.1.0/src/vollseg_napari_trackmate.egg-info/PKG-INFO`
...
### Comparing `vollseg-napari-trackmate-2.0.7/src/vollseg_napari_trackmate.egg-info/SOURCES.txt` & `vollseg-napari-trackmate-2.1.0/src/vollseg_napari_trackmate.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `vollseg-napari-trackmate-2.0.7/tox.ini` & `vollseg-napari-trackmate-2.1.0/tox.ini`
